...
We will also test memory functionality, by assigning functions and variables, and using these in expressions. Lastly we will also test certain arithemic edge cases, such as rounding and using boundary values.
%% COMMENT: A bit short.
