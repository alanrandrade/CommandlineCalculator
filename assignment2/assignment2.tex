...
Function and variable assignments are not tested yet since this would
require a more complex model and could potentionally take mor effort
than rewriting our SUT.

%% Expand if our test suite expands
...
%%  LocalWords:  txt STDOUT STDERR CommandLineCalculator SockServ
%%  LocalWords:  STDIN
